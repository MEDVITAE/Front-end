        ...
        <>
            ...
            <h1 className="rowdies bold-30">Olá {nome ? nome.split(" ")[0] : ''}</h1>
                <div className="menuItens">
                    <a href="/perfil-funcionario/cadastro-funcionario" className="item roboto sbold-16">Cadastro Funcionario</a>
                    <a href="/perfil-funcionario/requisicao-sangue" className="item roboto sbold-16">Requisitar Doação</a>
                    <a href="/perfil-funcionario/agenda" className="item roboto sbold-16">Agenda de Doações</a>
                </div>
